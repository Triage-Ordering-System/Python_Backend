...
def add_patient(patient):
    ...
    todo1 = {"name" : patient.get_name(), "age": patient.get_age(), "symptoms":symptoms, "durations": durations, "severity": patient.get_severity, "Past History": patient.patient_history, "score": patient.score}
    todos = db.Patient
